...
class Administrador {
    ...
    //El metodo entregarRegalo(persona) busca el regalo,
    //lo agrega al MutableMap de regalosEntregados y allí se disparan los Observers
    fun entregarRegalo(persona : Persona){
        if(buscarRegalo(persona) != null){
            ...
            regalosObservers.forEach { it.NotificacionRegalo(regalo, persona)}
        }
    }
